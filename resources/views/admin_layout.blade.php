            ...
            <div class="leftside-navigation">
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{URL::to('/report-sell')}}">Báo cáo bán hàng</a></li>
                            <li><a href="{{URL::to('/report-import')}}">Báo cáo nhập hàng</a></li>
                            <li><a href="{{URL::to('/all-export')}}">Báo cáo tài chính</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;">
