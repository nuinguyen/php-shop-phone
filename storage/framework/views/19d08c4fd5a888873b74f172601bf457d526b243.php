        ...
        <div class="row">
            <div class="col-sm-5 col-sm-offset-1">
                <div class="login-form"><!--login form-->
                    ...
                    ?>
                    <form action="<?php echo e(URL::to('/signup')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                    ...
                    <button type="submit" class="btn btn-default"><a href="dang-nhap">login</a> </button>
...
<?php /**PATH E:\laravel\xampp\htdocs\shopsupper\resources\views/pages/user/show_signup.blade.php ENDPATH**/ ?>