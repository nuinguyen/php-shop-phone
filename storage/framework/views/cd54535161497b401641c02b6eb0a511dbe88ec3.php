                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="<?php echo e(URL::to('/news-detail')); ?>">Them Chi tiet tin tuc</a></li>
                            <li><a href="<?php echo e(URL::to('/all-news-detail')); ?>">Liet ke chi tiet tin tuc</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="<?php echo e(URL::to('/import')); ?>">Thêm đơn nhạp hàng</a></li>
                            <li><a href="<?php echo e(URL::to('/all-import')); ?>">Danh sách đơn nhập hàng</a></li>
                            <li><a href="<?php echo e(URL::to('/export')); ?>">Thêm đơn xuat hàng</a></li>
                            <li><a href="<?php echo e(URL::to('/all-export')); ?>">Danh sách đơn xuat hàng</a></li>
                            <li><a href="<?php echo e(URL::to('/warehouse')); ?>">trich xuat Kho</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;">
