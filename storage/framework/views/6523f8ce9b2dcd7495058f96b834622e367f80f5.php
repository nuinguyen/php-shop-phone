...
<head>
    ...
    <link href="<?php echo e(asset('public/frontend/css/lightgallery.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('public/frontend/css/lightslider.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('public/frontend/css/prettify.css')); ?>" rel="stylesheet">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            ?>
                            <li class="cart-hover"><a href="<?php echo e(url('cart')); ?>"><i class="fa fa-shopping-cart"></i>
                                    Giỏ hàng
                            ...
                            ?>
                            <li><a href="<?php echo e(URL::to('/admin')); ?>"><i class="fa fa-lock"></i> Giỏ hàng</a></li>
                            <?php
                            }
                            ?>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo e(URL::to('/my-order')); ?>">Don hang</a></li>
                                    <li><a href="<?php echo e(URL::to('/profile')); ?>">Thong tin</a></li>
                                    <li><a href="<?php echo e(URL::to('/dang-xuat')); ?>">Dang xuat</a></li>
                            ...
                            ?>
                            <li><a href="<?php echo e(URL::to('/admin')); ?>"><i class="fa fa-lock"></i> Đăng nhập</a></li>
                            <?php
                            }
                            ?>
                        </ul>
                            ...
                            <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a href="<?php echo e(URL::to('/danh-muc/'.$cate->category_id)); ?>"><?php echo e($cate->category_name); ?></a></li>
                    ...
                    <div class="carousel-inner">
                        ...
                        <?php $__currentLoopData = $all_banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $key+1;
                            ?>
                            <div class="item <?php echo e($key==1 ? 'active' : ''); ?>">

                                <div class="col-sm-12">
                                    <img alt="<?php echo e($banner->banner_desc); ?>" src="<?php echo e(asset('public/uploads/banner/'.$banner->banner_image)); ?>" height="300" width="90%" >
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="<?php echo e(URL::to('/danh-muc/'.$cate->category_id)); ?>"><?php echo e($cate->category_name); ?></a></h4>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        $('.all_product').change(function () {
           if(this.checked){
            ...
            $('.cart_quantity_down').click(function () {
                ...
                $.ajax({
                    url: '<?php echo e(url('/update-quantity')); ?>',
                    method: 'POST',
    ...
    load_gallery();
        ...
        function load_gallery() {
            $('.check_coupon').click(function () {
                ...
                // alert(district);
                $.ajax({
                    url: '<?php echo e(url('/calculate-sale')); ?>',
                    method: 'POST',
...
<script>
    $(document).ready(function(){
        $('.choose').change(function(){
            ...
            $.ajax({
                url : '<?php echo e(url('/select-address')); ?>',
                method: 'POST',
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            url : '<?php echo e(url('/select-ship-home')); ?>',
            method: 'POST',
            data:{action:action,ma_id:ma_id,_token:_token},
            success:function(data){
                $('#'+result).html(data);
...
<?php /**PATH E:\laravel\xampp\htdocs\shopsupper\resources\views/layout.blade.php ENDPATH**/ ?>